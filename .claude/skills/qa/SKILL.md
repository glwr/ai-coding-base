...
**Web (Platform = Web):**
If production-ready:
> "All tests passed! Next step: Run `/security` to audit for vulnerabilities."
...
**Apple (Platform = Apple):**
If production-ready:
> "All tests passed! Next step: Run `/security` for a security audit, then `/hig-review` for HIG compliance, then `/apple-build` to build and archive, then `/release`."
